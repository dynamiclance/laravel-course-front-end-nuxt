        ...
        <div class="container mx-auto">
            <ul class="flex items-center flex-nowrap justify-between gap-y-7 gap-3">
                <li class="w-full lg:max-w-[165px]">
                    <NuxtLink to="" class="bg-white border mx-auto border-orange box-shadow w-full h-12 md:h-16 rounded-lg flex items-center justify-center">
...
<script setup>
 ...
 const {data: courses} = await useFetch(`http://laravel-courses.test/api/courses`)

 //const courses = await $fetch('http://127.0.0.1:8000/api/courses') 
 console.log(courses)
