        ...
        <div class="container mx-auto">
          ...
          <nav class="flex mt-0">
            <ol role="list" class="flex items-center space-x-0.5">
              <li>
                <div class="-m-1">
                  <NuxtLink to="/" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">Home</NuxtLink>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <div class="-m-1">
                  <NuxtLink to="/courses" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">Courses</NuxtLink>
                  </div>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <div class="-m-1">
                     <router-link to="/" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">{{ course.slug }}</router-link>
                  </div>
                </div>
              </li>
            </ol>
          ...
          <div class="flex mt-8">
              ...
              <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                ...
                <div class="rounded-sm mt-8 shadow-sm">
                  <img class="w-full h-80" sizes="(max-width: 1200px) 1200px, 2000px" :src="`${course.image_url}`" alt={{ course.title }}>
                  <div class="py-6">
                    ...
                    <div class="space-y-4 p-6">
                      ...
                      <div class="space-y-4 pb-2">
                        ...
                        <div class="space-y-1 text-lg font-medium leading-6 text-center">
                          <h4 class="font-semibold">{{ course.submitted_by.name }}</h4>
                        </div>
...
<script setup>
  ...
  //const {data: course} = await useFetch(`http://laravel-courses.test/api/course/${route.params.slug}`)

  const course = await $fetch(`http://laravel-courses.test/api/course/${route.params.slug}`);
